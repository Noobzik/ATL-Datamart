...
def download_parquet_file(**kwargs):
...
def upload_to_minio(**kwargs):
    ti = kwargs['ti']
    local_file_path = ti.xcom_pull(task_ids='download_parquet_file')
    try:
        ...
        raise RuntimeError("Impossible de se connecter à MinIO. Vérifiez que MinIO est en cours d'exé>    except S3Error as e:")
...
with DAG(
    ...
    upload_task = PythonOperator(
        ...
        python_callable=upload_to_minio, #Pas de lambda ici
    )

...
-- 2. Configuration du serveur source
...
-- 4. Création de la table étrangère (adaptez les colonnes à votre schéma réel)
...
-- Insertion automatisée des 265 zones officielles
...
SELECT
    -- Génération d'un ID unique basé sur les données temporelles et spatiales
    md5(
